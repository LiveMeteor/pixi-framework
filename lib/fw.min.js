...
(function (fw) {
    var GResponserIns = (function (_super) {
        ...
        GResponserIns.prototype.postMessage = function (type, data) {
            ...
            if (!fw.Config.isDebug && type != "sensors") {
                window.parent.postMessage({ type: "clientLog", data: "[SEND] type: " + type + " data: " + JSON.stringify(data) }, "*");
            }
...
//# sourceMappingURL=fw.min.js.map